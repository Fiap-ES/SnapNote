...
**Tirar uma foto.** Toque no botão redondo no centro da barra inferior. O ícone de raio na barra superior liga e desliga o flash; o ícone de setas circulares, à direita do obturador, troca entre a câmera traseira e a frontal. A tela de câmera é um protótipo de interface: os demais ícones da barra superior, os controles de zoom, os modos (Noite, Retrato, Vídeo e outros) e o ícone sobre o preview são apenas decorativos e mostram um aviso ao serem tocados.

**Escrever ou ditar a anotação.** Depois da captura, a foto aparece com um campo de texto. Escreva a anotação ou toque no microfone e fale; na primeira vez o aplicativo pede permissão para usar o microfone. O texto reconhecido substitui o conteúdo do campo. Se já houver texto, o aplicativo pergunta antes de substituir. Toque em Salvar para gravar a anotação na foto ou em Descartar para apagar a foto. Salvar com o campo vazio guarda a foto sem anotação.
...
**Visualizar uma foto com sua anotação.** Toque em uma miniatura para abrir a foto em tela cheia. Puxe a alça na parte de baixo para ver a anotação, o nome do arquivo e a data da captura; puxe para baixo para recolher. O lápis no topo abre a anotação para edição e a lixeira exclui a foto, com confirmação.
